...
stb   [$r0,  a],        $r1   ;CHECK: stb [$r0, a],   $r1  ; encoding: [0b00001AAA,0xb0,0x00,0x00]
stb   [$r7,  b],        $r2   ;CHECK: stb [$r7, b],   $r2  ; encoding: [0b11010AAA,0xb1,0x00,0x00]
stb   [$r1,  (c - a)],  $r50  ;CHECK: stb [$r1, c-a], $r50 ; encoding: [0b01010AAA,0xb0,0x30,0x00]
...
stb   [$r7+,  a],        $r6   ;CHECK: stb [$r7+,  a],   $r6  ; encoding: [0b11110AAA,0xb3,0x00,0x00]
stb   [-$r0,  b],        $r3   ;CHECK: stb [-$r0,  b],   $r3  ; encoding: [0b00011AAA,0xb4,0x00,0x00]
stb   [$r1+,  (b + a)],  $r8   ;CHECK: stb [$r1+,  b+a], $r8  ; encoding: [0b01000AAA,0xb2,0x08,0x00]
...
stw   [$r7,  b],        $r2   ;CHECK: stw [$r7, b],   $r2  ; encoding: [0b11010AAA,0xb9,0x00,0x00]
stw   [$r1,  (c - a)],  $r50  ;CHECK: stw [$r1, c-a], $r50 ; encoding: [0b01010AAA,0xb8,0x30,0x00]
...
stw   [$r7+,  a],  $r6   ;CHECK: stw [$r7+,  a], $r6 ; encoding: [0b11110AAA,0xbb,0x00,0x00]
stw   [-$r0,  b],  $r3   ;CHECK: stw [-$r0,  b], $r3 ; encoding: [0b00011AAA,0xbc,0x00,0x00]
