...
static cl::opt<bool> DebugTrace("debug-trace",
                                cl::desc("Enable debug tracing"));

static cl::opt<bool> DebugTrace2("d", cl::desc("Enable debug tracing"),
                                 cl::Hidden);

static cl::opt<double> Timeout("timeout", cl::desc("Timeout in seconds"),
                               cl::value_desc("duration"), cl::init(0.0));
...
int main(int argc, char **argv) {
  ...
  std::chrono::time_point<std::chrono::system_clock,
      ...
      timeoutEnd = std::chrono::system_clock::now() +
